...
return (new CustomEvent(event_name,(function (){var obj63384 = ({"detail":data});
return obj63384;
})()));
} else {
...
var f = (function (){var pred__63391 = cljs.core._EQ_;
var expr__63392 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__63391.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__63392))){
return (function (p1__63385_SHARP_){
return console.warn(p1__63385_SHARP_);
});
} else {
if(cljs.core.truth_(pred__63391.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__63392))){
return (function (p1__63386_SHARP_){
return console.debug(p1__63386_SHARP_);
});
} else {
if(cljs.core.truth_(pred__63391.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__63392))){
return (function (p1__63387_SHARP_){
return console.error(p1__63387_SHARP_);
});
} else {
return (function (p1__63388_SHARP_){
return console.log(p1__63388_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__63395){
var map__63396 = p__63395;
var map__63396__$1 = (((((!((map__63396 == null))))?(((((map__63396.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__63396.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__63396):map__63396);
var opts = map__63396__$1;
var eval_fn = cljs.core.get.call(null,map__63396__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__63398_SHARP_){
return new_def.callback(p1__63398_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__63399){
var vec__63400 = p__63399;
var ky = cljs.core.nth.call(null,vec__63400,(0),null);
var v = cljs.core.nth.call(null,vec__63400,(1),null);
...
}catch (e63405){if((e63405 instanceof Error)){
var e = e63405;
return not_found;
} else {
throw e63405;
...
//# sourceMappingURL=utils.js.map?rel=1589677418085
