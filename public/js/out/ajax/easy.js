...
if(cljs.core.vector_QMARK_.call(null,format)){
return cljs.core.apply.call(null,cljs.core.vector,cljs.core.map.call(null,(function (p1__53633_SHARP_){
return ajax.easy.keyword_response_format_element.call(null,p1__53633_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__53634){
var map__53635 = p__53634;
var map__53635__$1 = (((((!((map__53635 == null))))?(((((map__53635.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53635.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53635):map__53635);
var handler = cljs.core.get.call(null,map__53635__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.call(null,map__53635__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.call(null,map__53635__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__53637){
var vec__53638 = p__53637;
var ok = cljs.core.nth.call(null,vec__53638,(0),null);
var result = cljs.core.nth.call(null,vec__53638,(1),null);
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__53641){
var map__53642 = p__53641;
var map__53642__$1 = (((((!((map__53642 == null))))?(((((map__53642.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53642.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__53642):map__53642);
var opts = map__53642__$1;
var method = cljs.core.get.call(null,map__53642__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.call(null,map__53642__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.call(null,map__53642__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.call(null,map__53642__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.call(null,map__53642__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
...
//# sourceMappingURL=easy.js.map?rel=1589677408822
