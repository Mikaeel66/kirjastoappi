...
var map__56118 = top_item;
var map__56118__$1 = (((((!((map__56118 == null))))?(((((map__56118.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56118.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__56118):map__56118);
...
}catch (e56117){var _e = e56117;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___56120 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5733__auto___56120)){
var seen_errors_56121 = temp__5733__auto___56120;
if(cljs.core.truth_(seen_errors_56121.has(self))){
} else {
seen_errors_56121.add(self);

var temp__5735__auto___56122 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5735__auto___56122)){
var sense_56123 = temp__5735__auto___56122;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_56123)].join(''));
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1589677412182
