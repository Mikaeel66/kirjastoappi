...
var o49991 = temp__5733__auto__;
var temp__5733__auto____$1 = (o49991["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o49992 = temp__5733__auto____$1;
return (o49992["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22534__auto__ = f;
return (o__22534__auto__["toString"]).call(o__22534__auto__);
} else {
return "";
}
}catch (e49993){var _ = e49993;
return "";
}});
...
try{var o__22534__auto___49995 = t;
(o__22534__auto___49995["cljs$lang$ctorPrWriter"]).call(o__22534__auto___49995,t,writer);
}catch (e49994){var __49996 = e49994;
}
...
var char_code = (function (){var o__22534__auto__ = (new String(char$));
return (o__22534__auto__["charCodeAt"]).call(o__22534__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22534__auto__ = String;
return (o__22534__auto__["fromCharCode"]).call(o__22534__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__49997 = num_code;
switch (G__49997) {
case (1):
return (185);
...
var o__22534__auto__ = String;
return (o__22534__auto__["fromCharCode"]).call(o__22534__auto__,superscript_code);
});
/**
...
}catch (e49999){var _e__22541__auto__ = e49999;
return false;
}})())){
...
var vec__50000 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__50000,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o50003 = temp__5733__auto__;
var temp__5733__auto____$1 = (o50003["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o50004 = temp__5733__auto____$1;
return (o50004["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4789__auto___50011 = arguments.length;
var i__4790__auto___50012 = (0);
while(true){
if((i__4790__auto___50012 < len__4789__auto___50011)){
args__4795__auto__.push((arguments[i__4790__auto___50012]));

var G__50013 = (i__4790__auto___50012 + (1));
i__4790__auto___50012 = G__50013;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__50007){
var vec__50008 = p__50007;
var ns_detector = cljs.core.nth.call(null,vec__50008,(0),null);
...
var G__50014 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__50015 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__50014;
remaining_tokens = G__50015;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq50005){
var G__50006 = cljs.core.first.call(null,seq50005);
var seq50005__$1 = cljs.core.next.call(null,seq50005);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50006,seq50005__$1);
}));
...
var vec__50019 = cljs.core.split_with.call(null,(function (p1__50018_SHARP_){
return cljs.core.not_EQ_.call(null,p1__50018_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__50019,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__50019,(1),null);
...
var vec__50025 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__50025,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__50025,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__50028 = cljs.core.rest.call(null,remaining_tokens);
var G__50029 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__50028;
name_tokens = G__50029;
continue;
} else {
...
var vec__50032 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__50032,(0),null);
var arity = cljs.core.nth.call(null,vec__50032,(1),null);
var vec__50035 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__50035,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__50035,(1),null);
var vec__50038 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__50038,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__50038,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__50038,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__50038,(3),null);
...
var vec__50044 = result;
var munged_ns = cljs.core.nth.call(null,vec__50044,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__50044,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__50044,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__50044,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__50044,(4),null);
var arity = cljs.core.nth.call(null,vec__50044,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__50048 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__50048,(0),null);
var args = cljs.core.nth.call(null,vec__50048,(1),null);
var vec__50051 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__50051,(0),null);
var name = cljs.core.nth.call(null,vec__50051,(1),null);
...
var G__50054 = (arity + (1));
var G__50055 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__50056){
var vec__50057 = p__50056;
var arity = cljs.core.nth.call(null,vec__50057,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__50057,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__50060_SHARP_){
return cljs.core.get.call(null,arities,p1__50060_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.call(null,devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.call(null,(function (p1__50061_SHARP_){
return cljs.core.drop.call(null,(2),p1__50061_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__50064){
var vec__50065 = p__50064;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__50065,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq50062){
var G__50063 = cljs.core.first.call(null,seq50062);
var seq50062__$1 = cljs.core.next.call(null,seq50062);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50063,seq50062__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__50073__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__50073__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__50073__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__50073__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__50074 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__50074,(0),null);
var fn_name = cljs.core.nth.call(null,vec__50074,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__50074,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__50074,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__50074,(4),null);
var arity = cljs.core.nth.call(null,vec__50074,(5),null);
...
var o__22534__auto__ = f;
return (o__22534__auto__["getBasis"]).call(o__22534__auto__);
});
/**
...
}catch (e50078){var _e__22541__auto__ = e50078;
...
var G__50079 = (obj[cljs.core.first.call(null,path)]);
var G__50080 = cljs.core.rest.call(null,path);
obj = G__50079;
path = G__50080;
continue;
} else {
...
var _STAR_ = (function (accum,p__50081){
var vec__50082 = p__50081;
var bit = cljs.core.nth.call(null,vec__50082,(0),null);
var protocol = cljs.core.nth.call(null,vec__50082,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__50085){
var vec__50086 = p__50085;
var ns = cljs.core.nth.call(null,vec__50086,(0),null);
var name = cljs.core.nth.call(null,vec__50086,(1),null);
var selector = cljs.core.nth.call(null,vec__50086,(2),null);
...
var post_process = (function (p__50090){
var vec__50091 = p__50090;
var munged_name = cljs.core.nth.call(null,vec__50091,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__50091,(1),null);
...
var sorted_fns = cljs.core.map.call(null,(function (p1__50089_SHARP_){
return (obj[cljs.core.first.call(null,p1__50089_SHARP_)]);
}),sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1589677404928
