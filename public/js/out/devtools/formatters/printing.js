...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq50168){
var G__50169 = cljs.core.first.call(null,seq50168);
var seq50168__$1 = cljs.core.next.call(null,seq50168);
var G__50170 = cljs.core.first.call(null,seq50168__$1);
var seq50168__$2 = cljs.core.next.call(null,seq50168__$1);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__50169,G__50170,seq50168__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__50174_SHARP_){
return (!((cljs.core.meta.call(null,p1__50174_SHARP_) == null)));
})))){
...
var map__50175 = opts;
var map__50175__$1 = (((((!((map__50175 == null))))?(((((map__50175.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__50175.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__50175):map__50175);
var markup_db = cljs.core.get.call(null,map__50175__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e50179){var _e__22541__auto__ = e50179;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e50181){var _e__22541__auto__ = e50181;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__50183 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__50184 = devtools.formatters.state.get_current_state.call(null);
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__50184);

try{var map__50185 = opts;
...
var markup_db = cljs.core.get.call(null,map__50185__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__50183);
}});
...
var temp__5733__auto___50190 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__5733__auto___50190)){
var managed_print_level_50191 = temp__5733__auto___50190;
var _STAR_print_level_STAR__orig_val__50188_50192 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__50189_50193 = managed_print_level_50191;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__50189_50193);

try{devtools.formatters.state.update_current_state_BANG_.call(null,(function (p1__50187_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__50187_SHARP_,null);
}));

job_fn.call(null);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__50188_50192);
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1589677405158
