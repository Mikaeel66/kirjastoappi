...
var G__56907 = (function (){var G__56905 = sb;
G__56905.append(cljs.tools.reader.reader_types.read_char.call(null,rdr));

return G__56905;
})();
var G__56908 = cljs.tools.reader.reader_types.peek_char.call(null,rdr);
sb = G__56907;
ch = G__56908;
continue;
}
...
var temp__5733__auto____$2 = cljs.tools.reader.edn.read_tagged.call(null,(function (){var G__56909 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__56909,ch);
...
var vec__56917 = cljs.tools.reader.edn.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__56917,(0),null);
var start_column = cljs.core.nth.call(null,vec__56917,(1),null);
...
var G__56921 = (((!((mret === rdr))))?cljs.core.conj_BANG_.call(null,a,mret):a);
a = G__56921;
continue;
} else {
var o = cljs.tools.reader.edn.read.call(null,(function (){var G__56920 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__56920,ch);

return G__56920;
})(),true,null,opts);
var G__56922 = (((!((o === rdr))))?cljs.core.conj_BANG_.call(null,a,o):a);
a = G__56922;
continue;
}
}
...
var vec__56923 = cljs.tools.reader.edn.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__56923,(0),null);
var start_column = cljs.core.nth.call(null,vec__56923,(1),null);
...
var sb = (function (){var G__56926 = (new goog.string.StringBuffer());
G__56926.append(initch);
...
var G__56928 = (function (){var G__56927 = sb;
G__56927.append(ch);

return G__56927;
})();
var G__56929 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__56928;
ch = G__56929;
continue;
}
...
while(true){
var G__56932 = ch;
if(cljs.core._EQ_.call(null,null,G__56932)){
...
if(cljs.core._EQ_.call(null,"\\",G__56932)){
var G__56935 = (function (){var G__56933 = sb;
G__56933.append(cljs.tools.reader.edn.escape_char.call(null,sb,rdr));

return G__56933;
})();
var G__56936 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__56935;
ch = G__56936;
continue;
} else {
...
var G__56937 = (function (){var G__56934 = sb;
G__56934.append(ch);

return G__56934;
})();
var G__56938 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__56937;
ch = G__56938;
continue;
...
var G__56942 = rdr;
cljs.tools.reader.edn.read.call(null,G__56942,true,null,true);
...
var temp__5733__auto__ = (function (){var G__56943 = token;
var G__56943__$1 = (((G__56943 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__56943));
if((G__56943__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__56943__$1);
}
})();
if(cljs.core.truth_(temp__5733__auto__)){
...
var G__56944 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__56944)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__56944)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__56944)){
...
(cljs.tools.reader.edn.read.cljs$core$IFn$_invoke$arity$2 = (function (p__56951,reader){
var map__56952 = p__56951;
var map__56952__$1 = (((((!((map__56952 == null))))?(((((map__56952.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56952.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__56952):map__56952);
var opts = map__56952__$1;
var eof = cljs.core.get.call(null,map__56952__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
...
//# sourceMappingURL=edn.js.map?rel=1589677413911
