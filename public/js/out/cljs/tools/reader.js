...
var G__56720 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__56720;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__56721 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__56721,ch);
...
if(("\\" === ch__$1)){
var ch_56722__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_56722__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_56722__$2);
} else {
}

var G__56723 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__56723;
continue;
}
}
...
var vec__56731 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__56731,(0),null);
var start_column = cljs.core.nth.call(null,vec__56731,(1),null);
...
var G__56734 = cljs.core.conj_BANG_.call(null,a,form);
a = G__56734;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__56735 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__56736 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__56736);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__56735);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__56737 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__56737,(0),null);
var start_column = cljs.core.nth.call(null,vec__56737,(1),null);
...
var vec__56740 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__56740,(0),null);
var end_column = cljs.core.nth.call(null,vec__56740,(1),null);
...
var vec__56743 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__56743,(0),null);
var start_column = cljs.core.nth.call(null,vec__56743,(1),null);
...
var vec__56746 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__56746,(0),null);
var end_column = cljs.core.nth.call(null,vec__56746,(1),null);
...
var vec__56749 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__56749,(0),null);
var start_column = cljs.core.nth.call(null,vec__56749,(1),null);
...
var vec__56752 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__56752,(0),null);
var end_column = cljs.core.nth.call(null,vec__56752,(1),null);
...
var sb = (function (){var G__56755 = (new goog.string.StringBuffer());
G__56755.append(initch);
...
var G__56757 = (function (){var G__56756 = sb;
G__56756.append(ch);

return G__56756;
})();
var G__56758 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__56757;
ch = G__56758;
continue;
}
...
switch (G__56761) {
case "\\":
var G__56765 = (function (){var G__56762 = sb;
G__56762.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__56762;
})();
var G__56766 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__56765;
ch = G__56766;
continue;
...
break;
default:
var G__56767 = (function (){var G__56763 = sb;
G__56763.append(ch);

return G__56763;
})();
var G__56768 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__56767;
ch = G__56768;
continue;
...
var vec__56769 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__56769,(0),null);
var end_column = cljs.core.nth.call(null,vec__56769,(1),null);
...
var vec__56772 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__56772,(0),null);
var column = cljs.core.nth.call(null,vec__56772,(1),null);
...
var vec__56777 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__56777,(0),null);
var column = cljs.core.nth.call(null,vec__56777,(1),null);
...
var vec__56782 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__56782,(0),null);
var column = cljs.core.nth.call(null,vec__56782,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__56787 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__56787,(0),null);
var start_column = cljs.core.nth.call(null,vec__56787,(1),null);
...
var vec__56790 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__56790,(0),null);
var end_column = cljs.core.nth.call(null,vec__56790,(1),null);
...
var G__56793 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__56793,true,null,opts,pending_forms);
...
var G__56794 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__56794)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__56794)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__56794)){
...
var _STAR_suppress_read_STAR__orig_val__56795 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__56796 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__56796);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__56795);
}});
...
var G__56797 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__56797,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__56797,rdr,first_line);
...
var G__56801 = matched;
var G__56802 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__56801;
finished = G__56802;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__56803 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__56804 = (function (){var or__4185__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__56804);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__56803);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__56805 = cljs.tools.reader.arg_env;
var arg_env_temp_val__56806 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__56806);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__56807 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__56807,"(");
...
var G__56808 = (i + (1));
var G__56809 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4185__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__56805);
}});
/**
...
var ch = temp__5733__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__56810 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__56810);
...
var G__56811 = cljs.core.next.call(null,s__$1);
var G__56812 = ret;
s__$1 = G__56811;
r = G__56812;
continue;
...
var G__56813 = cljs.core.next.call(null,s);
var G__56814 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__56813;
key_vals = G__56814;
continue;
} else {
...
var gensym_env_orig_val__56819 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__56820 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__56820);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__56819);
}});
...
var temp__5733__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__56821 = token;
var G__56821__$1 = (((G__56821 == null))?null:cljs.core.subs.call(null,G__56821,(1)));
var G__56821__$2 = (((G__56821__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__56821__$1));
var G__56821__$3 = (((G__56821__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__56821__$2));
var G__56821__$4 = (((G__56821__$3 == null))?null:cljs.core.symbol.call(null,G__56821__$3));
if((G__56821__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__56821__$4);
}
})():(function (){var G__56822 = token;
var G__56822__$1 = (((G__56822 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__56822));
if((G__56822__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__56822__$1);
}
})()
));
if(cljs.core.truth_(temp__5733__auto__)){
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__56833,reader){
var map__56834 = p__56833;
var map__56834__$1 = (((((!((map__56834 == null))))?(((((map__56834.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56834.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__56834):map__56834);
var opts = map__56834__$1;
var eof = cljs.core.get.call(null,map__56834__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1589677413634
