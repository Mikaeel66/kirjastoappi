...
var G__49153 = o;
goog.object.set(G__49153,reagent.impl.template.cached_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
var G__49157 = o;
goog.object.set(G__49157,reagent.impl.template.cached_custom_prop_name.call(null,k),reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__49158__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
while (G__49159__i < G__49159__a.length) {G__49159__a[G__49159__i] = arguments[G__49159__i + 0]; ++G__49159__i;}
  args = new cljs.core.IndexedSeq(G__49159__a,0,null);
} 
return G__49158__delegate.call(this,args);};
G__49158.cljs$lang$maxFixedArity = 0;
G__49158.cljs$lang$applyTo = (function (arglist__49160){
var args = cljs.core.seq(arglist__49160);
return G__49158__delegate(args);
});
...
var G__49161 = props;
var G__49161__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__49161,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__49161);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__49161__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__49161__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class.call(null,(function (){var G__49162 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__49162,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.call(null,class$));
} else {
return G__49162;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__49163){
...
var on_write = cljs.core.get.call(null,map__49164__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__49166_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__49166_SHARP_);
}));
} else {
return null;
}
...
var vec__49169 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__49169,(0),null);
var id = cljs.core.nth.call(null,vec__49169,(1),null);
var className = cljs.core.nth.call(null,vec__49169,(2),null);
...
var temp__5739__auto___49173 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5739__auto___49173 == null)){
} else {
var key_49174 = temp__5739__auto___49173;
(jsprops.key = key_49174);
}
...
var temp__5739__auto___49175 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5739__auto___49175 == null)){
} else {
var key_49176 = temp__5739__auto___49175;
(jsprops.key = key_49176);
}
...
var temp__5739__auto___49177 = reagent.impl.template.get_key.call(null,cljs.core.meta.call(null,argv));
if((temp__5739__auto___49177 == null)){
} else {
var key_49178 = temp__5739__auto___49177;
(jsprops.key = key_49178);
}
...
var G__49180 = n;
if(cljs.core._EQ_.call(null,"",G__49180)){
return x;
} else {
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq49181){
var G__49182 = cljs.core.first.call(null,seq49181);
var seq49181__$1 = cljs.core.next.call(null,seq49181);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__49182,seq49181__$1);
}));
...
break;
default:
var G__49188 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__49188;
continue;
...
var ctx = ({});
var vec__49190 = reagent.ratom.check_derefs.call(null,(function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
}));
var res = cljs.core.nth.call(null,vec__49190,(0),null);
var derefed = cljs.core.nth.call(null,vec__49190,(1),null);
...
var G__49193 = (cljs.core.count.call(null,argv) - first_child);
switch (G__49193) {
case (0):
...
//# sourceMappingURL=template.js.map?rel=1589677403975
